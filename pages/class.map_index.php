...
class map_index extends core
{
	protected function GetInfo()
	{
		...
		return array
		(
			"menu" => array("Карта" => "Главная"), // Описываю меню. Т.е. Главный раздел "Карта" и в нём страница "Главная".
			"info" => "Карта города" // Описываю информацию страницы.
